...
export class CommonUtils {
  ...
  static sleep = (t:number) => new Promise((resolve) => setTimeout(resolve, t * 1000));
  ...
  */
  ...
  static isDateWithinInterval(interval:string,targetDate:Date): boolean {
    const now = new Date();
  ...
  private static encrypt_(value:any) {
  ...
  private static decrypt_(value:any) {
  ...
  static encrypt = (o:any) => this.encrypt_(JSON.stringify(o));
  static decrypt = (o:any) => JSON.parse(this.decrypt_(o));
}
