...
import { CommonUtils,popularColors,stateAbbreviations } from "../utils";
...
const CourierValidators = {
  CreateCourier:[[
    ...
    body('data.vehicle').isObject().custom(CommonUtils.notEmpty).withMessage('Invalid vehicle info').optional(),
    ...
    body('data.vehicle.color').if(body('data.vehicle').exists()).trim().escape().isIn([
      ...popularColors.map(o => o.name),
      ...popularColors.map(o => o.hex)
    ...
    body('data.vehicle.plateSt').if(body('data.vehicle').exists()).trim().escape().isIn(stateAbbreviations).withMessage('Invalid vehicle info'),
    ...
    body('data.insurance').isObject().custom(CommonUtils.notEmpty).withMessage('Invalid insurace data').optional(),
    body('data.insurance.num').if(body('data.insurance').exists()).trim().escape().matches(/^[0-9]{8,10}$/).withMessage('Invalid insurance data'),
    body('data.insurance.state').if(body('data.insurance').exists()).trim().escape().isIn(stateAbbreviations).withMessage('Invalid insurance data'),
  ...
  UpdateCourier:[[
    ...
    body('data.img').trim().escape().notEmpty().withMessage('Invalid image').optional(),
    body('data.vehicle').isObject().custom(CommonUtils.notEmpty).withMessage('Invalid preferences').optional(),
    ...
    body('data.vehicle.plateSt').if(body('data.vehicle').exists()).trim().escape().isIn(stateAbbreviations).withMessage('Invalid vehicle info').optional(),
    body('data.license').isObject().custom(CommonUtils.notEmpty).withMessage('Invalid preferences').optional(),
    ...
    body('data.insurance').isObject().custom(CommonUtils.notEmpty).withMessage('Invalid preferences').optional(),
    ...
    body('data.insurance.state').if(body('data.insurance').exists()).trim().escape().isIn(stateAbbreviations).withMessage('Invalid insurance data').optional(),
